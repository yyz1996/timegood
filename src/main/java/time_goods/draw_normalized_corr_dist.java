...
public class draw_normalized_corr_dist {
    ...
    public static void main(String[] args)
    {
        ...
        {
            String filename_corr="D:\\Java\\Test\\normalized_standard_corr_"+product[i]+".xls";
            String filename_dist="D:\\Java\\Test\\normalized_standard_dist_"+product[i]+".xls";
